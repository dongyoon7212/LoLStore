...
function GetBoard() {
  ...
  return (
    <div className="container mx-auto my-6 flex px-5 py-24 items-center justify-center flex-col text-2xl text-lolGold">
      아이템 검색
